...
public class BantuanAdapter extends RecyclerView.Adapter<BantuanAdapter.ViewHolder> {
    public List<com.app.app4g.features.petani.program_bantuan.bantuan.model.Result> bantuans;
    Activity context;



    public BantuanAdapter(List<com.app.app4g.features.petani.program_bantuan.bantuan.model.Result> data, Activity context) {
        this.bantuans = data;
