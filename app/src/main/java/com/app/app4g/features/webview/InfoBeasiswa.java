...
public class InfoBeasiswa extends AppCompatActivity implements AdvancedWebView.Listener{

    String TEST_PAGE_URL = "https://pmb.ppikubl.com/";
    ...
    public void onPageError(int errorCode, String description, String failingUrl) {
        Toast.makeText(InfoBeasiswa.this, "onPageError(errorCode = "+errorCode+",  description = "+description+",  failingUrl = "+failingUrl+")", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onExternalPageRequest(String url) {
        Toast.makeText(InfoBeasiswa.this, "onExternalPageRequest(url = "+url+")", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onBackPressed() {
        ...
        // ...
        Intent a = new Intent(InfoBeasiswa.this, MenuUtama.class);
        startActivity(a);
        finish();
        super.onBackPressed();
    }
