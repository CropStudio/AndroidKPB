...
public class PortalInformasi extends AppCompatActivity implements AdvancedWebView.Listener {
    ...
    public void onPageError(int errorCode, String description, String failingUrl) {
        Toast.makeText(PortalInformasi.this, "onPageError(errorCode = "+errorCode+",  description = "+description+",  failingUrl = "+failingUrl+")", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onExternalPageRequest(String url) {
        Toast.makeText(PortalInformasi.this, "onExternalPageRequest(url = "+url+")", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onBackPressed() {
        ...
        // ...
        Intent a = new Intent(PortalInformasi.this, MenuUtama.class);
        startActivity(a);
        finish();
        super.onBackPressed();
    }
