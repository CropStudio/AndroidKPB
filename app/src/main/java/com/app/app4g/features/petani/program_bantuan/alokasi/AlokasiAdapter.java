...
public class AlokasiAdapter extends RecyclerView.Adapter<AlokasiAdapter.ViewHolder> {
    public List<com.app.app4g.features.petani.program_bantuan.alokasi.model.Result> alokasis;
    Activity context;



    public AlokasiAdapter(List<com.app.app4g.features.petani.program_bantuan.alokasi.model.Result> data, Activity context) {
        this.alokasis = data;
