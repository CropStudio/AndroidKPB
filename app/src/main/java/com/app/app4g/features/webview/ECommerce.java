...
public class ECommerce extends AppCompatActivity implements AdvancedWebView.Listener{

    String TEST_PAGE_URL = "http://toko.kartupetaniberjaya.com/";
    ...
    public void onPageError(int errorCode, String description, String failingUrl) {
        Toast.makeText(ECommerce.this, "onPageError(errorCode = "+errorCode+",  description = "+description+",  failingUrl = "+failingUrl+")", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onExternalPageRequest(String url) {
        Toast.makeText(ECommerce.this, "onExternalPageRequest(url = "+url+")", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onBackPressed() {
        ...
        // ...
        Intent a = new Intent(ECommerce.this, MenuUtama.class);
        startActivity(a);
        finish();
        super.onBackPressed();
    }
