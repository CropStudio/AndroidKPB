...
public class AutpAdapter extends RecyclerView.Adapter<AutpAdapter.ViewHolder> {
    public List<com.app.app4g.features.petani.program_bantuan.autp.model.Result> autps;
    Activity context;
    ...
    public void onBindViewHolder(final AutpAdapter.ViewHolder holder, final int position) {
        final com.app.app4g.features.petani.program_bantuan.autp.model.Result autp = autps.get(position);
