package com.app.app4g.features.webview;
...
public class InfoKur extends AppCompatActivity implements AdvancedWebView.Listener{

    String TEST_PAGE_URL = "http://kur.ekon.go.id/sikp-kur";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_kur);
    ...
    public void onPageError(int errorCode, String description, String failingUrl) {
        Toast.makeText(InfoKur.this, "onPageError(errorCode = "+errorCode+",  description = "+description+",  failingUrl = "+failingUrl+")", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onExternalPageRequest(String url) {
        Toast.makeText(InfoKur.this, "onExternalPageRequest(url = "+url+")", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onBackPressed() {
        ...
        // ...
        Intent a = new Intent(InfoKur.this, MenuUtama.class);
        startActivity(a);
        finish();
        super.onBackPressed();
    }
