...
import com.app.kpb2.features.petani.profile.komoditas.IKomoditasView;
...
public class CreateProduksiPresenter {
    final ICreateProduksiView view;
    public final Retrofit restService;

    public CreateProduksiPresenter(ICreateProduksiView view) {
        this.view = view;
