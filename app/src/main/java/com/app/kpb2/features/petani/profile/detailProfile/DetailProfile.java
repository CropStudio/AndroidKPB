...
public class DetailProfile extends AppCompatActivity implements IDetailProfileView, View.OnClickListener {
    ...
    public void onDataReady(profile profile) {
        List<com.app.kpb2.features.petani.profile.model.profile.dataTambahan.DataAnak> anaks = new ArrayList<>();
        List<com.app.kpb2.features.petani.profile.model.profile.dataTambahan.TanggunganLain> tanggungans = new ArrayList<>();
        ...
        for (com.app.kpb2.features.petani.profile.model.profile.dataTambahan.DataAnak anak : anaks) {
        ...
        for (com.app.kpb2.features.petani.profile.model.profile.dataTambahan.TanggunganLain tanggungan : tanggungans) {
            LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
