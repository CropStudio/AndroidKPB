...
public class ResetPasswordPresenter {
    ...
    public void onResetPassword(String nik, String token,String password) {
        ...
        restService.newBuilder().client(RestService.getUnsafeOkHttpClient(nik , token).build()).build().create(NetworkService.class).onResetPassword(nik, params).enqueue(new Callback<LoginResponse>() {
            @Override
